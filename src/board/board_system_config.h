...
#define BOARD_SYSTEM_CONFIG_DEVICE_MODE                3
    ...
    #define BOARD_SYSTEM_CONFIG_AIR_HOVER_MODE         0
...
#if (BOARD_SYSTEM_CONFIG_DEVICE_MODE == 3)
    #define BOARD_SYSTEM_CONFIG_TRICOPTER_MODE         0
    #define BOARD_SYSTEM_CONFIG_FLIGHT_SAURCER_MODE    0
    #define BOARD_SYSTEM_CONFIG_AERO_0_MODE            0
    #define BOARD_SYSTEM_CONFIG_AIR_HOVER_MODE         1
#endif

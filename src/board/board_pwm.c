...
/*
    ...
    be_TIMER2_PWM_channel_init(CHANEL_4,PWM_PERIOD_ANALOG,PWM_DUTY_INITIAL);
*/
    be_TIMER2_PWM_channel_init(CHANEL_1,1500U,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_2,1500U,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_3,1500U,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_4,1500U,PWM_DUTY_INITIAL);
    /* Start TIMER2. */
    TIM_Cmd(TIM2, ENABLE);

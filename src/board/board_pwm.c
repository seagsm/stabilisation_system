...
BOARD_ERROR be_board_pwm_init(void)
{
    ...
    be_TIMER2_PWM_channel_init(CHANEL_1,PWM_PERIOD_DIGITAL,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_2,PWM_PERIOD_DIGITAL,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_3,PWM_PERIOD_DIGITAL,PWM_DUTY_INITIAL);
    be_TIMER2_PWM_channel_init(CHANEL_4,PWM_PERIOD_DIGITAL,PWM_DUTY_INITIAL);
    /* Start TIMER2. */
    TIM_Cmd(TIM2, ENABLE);

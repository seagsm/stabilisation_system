 ...
 /* HEAD HOLDING. */
    ...
    if( bc_ch_value.u16_channel_6_value <= (uint16_t)API_END_DEVICE_HEAD_HOLD_MODE_ON)
    {
      if(u8_head_hold_mode == 0U)
      {
        ...
        i32_head_hold_aero     = (int32_t)f_head_angle;
      }
    }
    else
    {
    ...
    {
        /* Calc head error. */
        i32_heading_error = i32_heading - i32_head_hold_aero;
    ...
    {   /* Set new head hold possition. */
        i32_head_hold_aero = i32_heading;
    }
#endif

...
static BOARD_ERROR be_api_CMD_data_answer_i32(uint16_t u16_data_id)
{
    ...
    switch(u16_data_id)
    {
        ...
        case 0x0060U:
            ...
            break;
        case 0x0061U:
            board_packet_send_answ_int32(u16_data_id, (int32_t)u32_board_baro_bmp085_get_pressure());
            break;
        case 0x0062U:
            board_packet_send_answ_int32(u16_data_id, i32_board_baro_bmp085_get_altitude());
            break;
        case 0x0063U:

...
#include "api_end_air_hover.h"
    ...
    #define API_END_DEVICE_AIR_HOVER            0  /* define AEROPLANE VERTICAL  mode. */
#endif
    ...
    #define API_END_DEVICE_FLIGHT_SAURCER       0  /* define SAUCER mode. */
    #define API_END_DEVICE_AERO_0               0  /* define AEROPLANE 0 mode. */
    #define API_END_DEVICE_AIR_HOVER            1  /* define AEROPLANE VERTICAL  mode. */
#endif
